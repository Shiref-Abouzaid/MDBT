            ...
            <div class="swiper" v-swiper:mySwiper="swiperOption">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="mini-cat"><nuxt-link exact :to="'/' + locale +'/services/restaurants'" class="active">All</nuxt-link></div>
                    </div>
                    <div class="swiper-slide" v-for="cat in categories" :key="cat.id">
                        <div class="mini-cat"><nuxt-link :to="'/' + locale +'/services/restaurants/' + cat.id + '/' + cat.name">{{cat.name}}</nuxt-link></div>
                    </div>
                </div>
